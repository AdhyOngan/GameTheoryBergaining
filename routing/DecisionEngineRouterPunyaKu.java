 ...
 */
public class DecisionEngineRouterPunyaKu extends ActiveRouter
{
	public static final String PUBSUB_NS = "DecisionEngineRouterPunyaKu";
	...
	protected RoutingDecisionEnginePunyaku decider;
	...
	public DecisionEngineRouterPunyaKu(Settings s)
	{
		super(s);
		...
		decider = (RoutingDecisionEnginePunyaku)routeSettings.createIntializedObject(
	...
	public DecisionEngineRouterPunyaKu(DecisionEngineRouterPunyaKu r)
	{
		super(r);
		outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
	...
	{
		return new DecisionEngineRouterPunyaKu(this);
	}
	...
	public void changedConnection(Connection con)
	{
		...
		DecisionEngineRouterPunyaKu otherRouter = (DecisionEngineRouterPunyaKu)otherNode.getRouter();
		if(con.isUp())
		{
...
//                tryAllMessagesToAllConnections();
	...
	public RoutingDecisionEnginePunyaku getDecisionEngine()
	{
		return this.decider;
	}
