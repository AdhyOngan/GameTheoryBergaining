 ...
 * @author Jarkom
 */
public class UangUntungReport extends Report {

    public static final String NODE_ID = "ToNodeID"; //Node yang ditemui
    private int nodeAddress;// Nodeku
    private Map<DTNHost, Double> uangSekarang;
    private Map<DTNHost, Double> avgBuffer;
//    private Double max;
//    private Double min;
    private List<Double> listUangSekarang;

    public UangUntungReport() {
        super();
        ...
        listUangSekarang = new LinkedList<>();
        uangSekarang = new HashMap<>();
    ...
    public void done() {
        ...
        for (DTNHost host : nodes) {
            ...
            List<Double> listUangSekarang = cd.getUangSekarang();
            String printLn = host+ " ";
            for (Double nilai : listUangSekarang) {
